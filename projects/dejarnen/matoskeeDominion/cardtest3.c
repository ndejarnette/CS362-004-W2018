...
int main()
{
	...
	result = cardCouncil_room(&testG, testG.hand[0][0]);
	asserttrue(result, 0, "return value for council_room through card effect\n");
	asserttrue(G.handCount[0] + 3, testG.handCount[0], "3 cards added to player 1 hand\n");
	// added for teammate code test
	...
	result = cardCouncil_room(&testG, testG.hand[1][0]);
	asserttrue(result, 0, "return value for council_room through card effect\n");
	asserttrue(G.handCount[1] + 3, testG.handCount[1], "3 cards added to player 2 hand\n");
	// added for teammate code test
	printf("Previous hand count: %d\n", G.handCount[0]);
	printf("Current hand count: %d\n", testG.handCount[0]);
